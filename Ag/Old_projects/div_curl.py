...
class VectorFieldFlow(Mobject):
    ...
    def __init__(self, mobject, func, **kwargs):
        ...
        """
        self.func = func
        mobject.add_updater(self.update_mobject)
...
class StreamLineAnimation(Mobject):
    CONFIG = {
        "lag_range": 4,
    ...
    def __init__(self, stream_lines, **kwargs):
        ...
        group.add_updater(self.update_mobject)
...
class JigglingSubmobjects(Mobject):
    CONFIG = {
        "amplitude": 0.05,
